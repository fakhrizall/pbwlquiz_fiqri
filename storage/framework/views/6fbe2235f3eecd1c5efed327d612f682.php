    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><a class="btn btn-info btn-sm float" href="<?php echo e(url('golongan/' .$row->gol_id. '/edit')); ?>">Edit</a></td>
                <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pbwlquiz_fiqri\resources\views/golongan/index.blade.php ENDPATH**/ ?>